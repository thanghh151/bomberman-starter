...
## Nhiệm vụ của bạn
- Gói bắt buộc (+8đ)
1. Thiết kế cây thừa kế cho các đối tượng game +2đ - done
2. Xây dựng bản đồ màn chơi từ tệp cấu hình (có mẫu tệp cấu hình, xem [tại đây](https://raw.githubusercontent.com/bqcuong/bomberman-starter/starter-2/res/levels/Level1.txt)) +1đ - done
3. Di chuyển Bomber theo sự điều khiển từ người chơi +1đ - done
4. Tự động di chuyển các Enemy +1đ - done
5. Xử lý va chạm cho các đối tượng Bomber, Enemy, Wall, Brick, Bomb +1đ - done
6. Xử lý bom nổ +1đ - done
7. Xử lý khi Bomber sử dụng các Item và khi đi vào vị trí Portal +1đ - done
